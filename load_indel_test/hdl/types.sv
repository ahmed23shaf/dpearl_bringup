package rl_types;
    ...
    // === Error Codes === 
    typedef enum logic [OUT_PKT_WIDTH-1:0] {
        ERR_UNINIT_CHIP         = 'd0,
        ERR_SEQ_OVERFLOW        = 'd1,
        ERR_HANG_WATCH          = 'd2
    } error_code_e;
    ...
    // ==============================================================================
    //          Definitions for debug controller struct
    // ==============================================================================
    ...
    typedef enum logic [1:0] {
        ...
        GRID_OUT,
        SRAM_OUT
    } debug_controller_out_type_e;

    // === Debug controller OUT packet ===
    typedef struct packed {
        debug_controller_out_type_e type_o;
        cell_cfg_t                  grid_cfg_o;
        logic [DELAY_WIDTH-1:0]     grid_indel_o;
        char_t                      char_q;
        char_t                      char_p;
        seq_e                       seq_type;
        logic [DELAY_WIDTH-1:0]     indel_reg_o;
        logic [DELAY_WIDTH-1:0]     sram_o;
    }dc_io_out_t;

...
set_property IOSTANDARD LVCMOS18 [get_ports {chip_rx_enqueue}]
set_property IOSTANDARD LVCMOS18 [get_ports {chip_tx_dequeue}]
...
#set_property IOSTANDARD LVCMOS12 [get_ports {chip_rx_enqueue}]
#set_property IOSTANDARD LVCMOS12 [get_ports {chip_tx_dequeue}]
